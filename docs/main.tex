...
\begin{titlepage}
  ...
  \vspace{0.7cm}
  {\bfseries Presentado por los Estudiantes:}\\[0.4cm]
  \begin{tabular}{ll}
    \toprule
...
\begin{center}
  \vspace*{1.2cm}
  {\Large\bfseries Enlaces principales de entrega}\\[0.4cm]

  \fcolorbox{flowblue}{blue!3}{%
    \begin{minipage}{0.90\textwidth}
      \sloppy
      \vspace{0.25cm}
      \textbf{Repositorio GitHub del proyecto:}\\[0.15cm]
      \url{https://github.com/ForLess01/ModelTitikaka}\\[0.45cm]

      \textbf{Carpeta Google Drive de respaldo y entrega:}\\[0.15cm]
      \href{https://drive.google.com/drive/folders/1FCQor2CJlfbp2tUAgSYsjr4WFx_gw_Ba?usp=sharing}%
        {\textcolor{blue!70!black}{\underline{Clic aquí para abrir Google Drive del proyecto}}}\\[0.45cm]

      \textbf{Nota:} en la carpeta de Drive se incluye una carpeta denominada
      \texttt{Resources}, donde se conservan fotografías y videos de respaldo
      utilizados como evidencia visual del trabajo de campo y de la muestra
      observada para contextualizar el sistema operativo del muelle.
      \vspace{0.25cm}
    \end{minipage}%
  }
\end{center}
...
(09:00 a 10:00 del 28 de mayo de 2026), basada en:
...
\begin{table}[H]
  \centering
  \caption{Ficha de observación sintética -- ventana 09:00 a 10:00 del 28 de mayo de 2026}
  \small
...
\subsection{Anexo C -- Registro visual del muelle y recursos de campo}

Como respaldo visual del sistema estudiado, se incluyen fotografías del
Muelle Turístico de Puno y de su entorno operativo. Estas imágenes ayudan a
contextualizar la llegada de visitantes, el espacio de embarque y la dinámica
general considerada en el modelo. Además, la carpeta de Google Drive del
proyecto contiene una carpeta denominada \texttt{Resources}, donde se
conservan fotografías y videos utilizados como evidencia visual del trabajo de
campo y de la muestra observada.

\begin{figure}[H]
  \centering
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{../images/muelle\space 1.png}
    \caption{Vista del Muelle Turístico de Puno -- registro 1}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{../images/muelle\space 2.png}
    \caption{Vista del Muelle Turístico de Puno -- registro 2}
  \end{subfigure}

  \vspace{0.45cm}

  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{../images/muelle\space 3.png}
    \caption{Vista del Muelle Turístico de Puno -- registro 3}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \includegraphics[width=\textwidth]{../images/muelle\space 4.png}
    \caption{Vista del Muelle Turístico de Puno -- registro 4}
  \end{subfigure}

  \caption{Registro visual del entorno operativo considerado para el proyecto.}
\end{figure}
